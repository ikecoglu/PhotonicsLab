...
annotation('textbox',[0.78 0.45 0.1 0.08],'String',{strcat('fc = ',num2str(Pwsx.fc),' Hz'),strcat('D = ',num2str(Pwsx.D))},'FontSize',14,'FontName','Calibri','LineWidth',2,'BackgroundColor',[0.9  0.9 0.9]);
