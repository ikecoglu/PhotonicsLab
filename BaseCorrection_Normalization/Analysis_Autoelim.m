...
trs = 1.8; % Treshhold for zscore elimination
...
CalInt_f = eliminationfunc(CalInt, trs);
...
title('Filtered CAL spectra')
%% Base correction

[BCInt, y] = base_correct(BasePoints, Calx, CalInt_f, mode);
