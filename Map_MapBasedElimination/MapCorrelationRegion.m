...
Point2map=1669;%the raman shift that is going to be mapped in 3d plot.
n=43;%averaging window size.
Normalize=1;
%% Reading data
...
clear Normalize
%% Process
peak=find(data(1,:,1)==Point2map);peak=peak-n:peak+n;
Int=data(:,peak,2);CorrData=CorrData(peak);
for i=1:size(Int,1)
